...
read_tweets <- function(from_N, to_N) { 
  tweetlist = list()
  setwd("/Users/donald/Desktop/Text_Analytics/")
...
focus_index <- read_csv("Time_index.csv")


setwd("/Users/donald/Desktop/Text_Analytics/data/")
stateGDP <- read_csv("/Users/donald/Desktop/Text_Analytics/data/state_gdp_growth.csv")
...
p2 <- p2 + geom_smooth(aes(color = "blue"), method = "lm")
print(p2)
...
stateSAT <- read_csv("/Users/donald/Desktop/Text_Analytics/Data/SAT_AVG_2017.csv")
...
stateACT <- read_csv("/Users/donald/Desktop/Text_Analytics/Data/ACT_AVG_2017.csv")
...
state_savesearch <- read_csv("/Users/donald/Desktop/Text_Analytics/Data/google_savings_search.csv")
state_medinc <- read_csv("/Users/donald/Desktop/Text_Analytics/Data/State_median_inc_2016.csv")
head(state_medinc)
